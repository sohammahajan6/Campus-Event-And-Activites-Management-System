...
//import project.college.event.organizer.display.eventmanage.finearts.FineArtsRegistration;
import project.college.event.organizer.events.FineArtsRegistration;
...
public class EventsRegister {
    public EventsRegister() {
        ...
        extracurricular.addActionListener(e -> {
            f.dispose();
            ExtracurricularRegistration ob = new ExtracurricularRegistration();
            ob.main(null);
        });
